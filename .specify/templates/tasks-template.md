...
test tasks that provide objective evidence for behavior changes.
...
- [ ] T004 [P] Define test harness updates and coverage targets for this feature
- [ ] T005 [P] Define UX consistency validation approach (snapshot, transcript,
      interaction checklist, or equivalent)
- [ ] T006 [P] Define performance measurement plan and tooling
...
- [ ] T015 [P] [US1] Unit tests for changed logic in tests/unit/test_[name].py
...
- [ ] T022 [US1] Validate UX consistency against existing interaction patterns
- [ ] T023 [US1] Run and record performance checks against defined budgets
...
- [ ] T026 [P] [US2] Unit tests for changed logic in tests/unit/test_[name].py
...
- [ ] T031 [US2] Validate UX consistency against existing interaction patterns
- [ ] T032 [US2] Run and record performance checks against defined budgets
...
- [ ] T035 [P] [US3] Unit tests for changed logic in tests/unit/test_[name].py
...
- [ ] T039 [US3] Validate UX consistency against existing interaction patterns
- [ ] T040 [US3] Run and record performance checks against defined budgets
...
- [ ] TXXX [P] Additional unit and integration tests for risk hotspots
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Validate constitution compliance checklist before merge
...
- UX consistency and performance validation tasks are mandatory when impacted
